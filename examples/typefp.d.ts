...
type CreateArray<L extends number> = L extends -1 | 0 ? [] : [number, ...CreateArray<Decrement<L>>];
...
export type IsNumber<S extends string> = S extends `${NumericChar}` ? true : S extends `${NumericChar}${infer Rest}` ? IsNumber<Rest> : false;